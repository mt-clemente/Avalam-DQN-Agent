...
class PrioritizedReplayMemory():
    ...
    def __init__(self, size,Transition,alpha, batch_size):
        ...
        self.next_state_buf = np.empty(size, dtype=Board)
...
class DQN(nn.Module):
    ...
    def __init__(self, h, w, outputs,device):
        ...
        self.device = device
        self.conv1 = nn.Conv2d(1, 9 * 9, kernel_size=K1)
        self.bn1 = nn.BatchNorm2d(9 * 9)
        self.conv2 = nn.Conv2d(9 * 9, 64, kernel_size=K2, stride=1)
        self.bn2 = nn.BatchNorm2d(64)
        self.conv3 = nn.Conv2d(64, 32, kernel_size=K3, stride=1)
        ...
        linear_input_size = convw * convh * LINFACT
...
class MoveBuffer():
    ...
    def update(self, statem: Board, reward):
        self.statem = statem
        self.reward = reward
